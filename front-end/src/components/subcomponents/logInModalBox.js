...
logInModalBox.classList.add('hidden', 'fixed', 'box-border-theme');
...
<form id="login"
    class="flex gap-x-8 px-20 mt-10 md:gap-x-2 max-lg:flex-col max-lg:gap-y-2 max-lg:px-10 max-lg:text-[10px]" autocomplete="off" target="_self">
